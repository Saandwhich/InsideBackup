...
final class OpenAIService {
    ...
    func analyzeMealDescription(
        ...
        let systemPrompt = """
        You are a meticulous nutrition assistant. Output STRICT JSON only (no extra text).
        Schema (for meal/description):
        {
          "name": string,
          "ingredients": string,
        ...
        RULES:
        - Do NOT assume foods are gluten-free, vegan, or allergen-free unless explicitly stated.
        - Default to traditional/traditional preparation of the food item.
        - Use the SAFETY SCORE REFERENCE below.
        - If you cannot produce valid JSON, return {} exactly.
        \(scoreReference)
        """
